# -*- coding: utf-8 -*-
"""
adapted from https://gitlab.com/enable-medicine-public/space-gm
...
def plot_graph(G, node_colors=None):
    ...
    # Add a legend to show the mapping between cell types and colors
    legend_elements = [matplotlib.lines.Line2D([0], [0], marker='o', color='w', label=ct,
                              markerfacecolor=cell_type_to_color[ct], markersize=8) 
